...
import { Instagram, Linkedin, ArrowRight, Sparkles, Globe, ArrowLeft } from 'lucide-react';
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-8 left-8 z-20">
        <Link 
          to="/"
          className="flex items-center px-4 py-2 bg-white/70 backdrop-blur-sm border border-gray-300 rounded-lg hover:bg-white/90 transition-all duration-300 text-gray-700 hover:text-gray-900 shadow-sm"
        >
